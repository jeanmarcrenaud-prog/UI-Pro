...
class TestShouldContinue:
    ...
    # Priorité 5: review "No code was generated" + pas d'exécution → end.
    # Le fix loop avec le même modèle + même prompt reproduirait la
    # même réponse vide — on coupe court pour épargner ~6 min d'attente.
