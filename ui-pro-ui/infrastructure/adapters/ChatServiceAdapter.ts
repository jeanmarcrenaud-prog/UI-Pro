// infrastructure/adapters/ChatServiceAdapter.ts
// Role: Chat Service - WebSocket client with auto-reconnect and resume support
...
class ChatServiceAdapter {
  ...
  private generateWsUrl(): string {
    ...
    return `${process.env.NEXT_PUBLIC_WS_URL?.replace('localhost', host) || 'ws://localhost:8000'}/ws`;
  }
...
export const chatService = new ChatServiceAdapter();
