...
Moved from core/memory.py as part of repository restructuring.
"""
...
try:
    ...
    logger.warning("Memory module: Optional dependencies (faiss, numpy, sentence-transformers) not available.")
    model = None
...
# Keep original interface for backward compat
