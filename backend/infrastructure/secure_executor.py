...
BLOCKED_MODULES = {"os", "sys", "subprocess", "shutil", "pathlib", "socket", "requests", "urllib", "http", "ftp", "pty", "tty", "termios", "fcntl"}
...
class SecureCodeExecutor:
    ...
    def _log_audit(self, result: Dict):
        ...
        logger.log(level, f"Code execution | hash={result['code_hash']} | "
